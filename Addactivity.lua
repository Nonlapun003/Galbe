...
function scene:show(event)
	...
	if (phase == "will") then
        ...
        txtName = display.newText("ชื่อกิจกรรม", cx-105, 110, "Arial", 15)
txtName:setFillColor(0)
txtAmt = display.newText("จำนวนเวลา", cx-115, 160, "Arial", 15 )
txtAmt:setFillColor(0)
txtKcal = display.newText("เผาผลาญ", cx-95, 210, "Arial", 15)
